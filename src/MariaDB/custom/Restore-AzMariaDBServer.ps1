...
function Restore-AzMariaDBServer {
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Category('Body')]
        [Validateset('GeoRestore', 'PointInTimeRestore')]
        [string]
    ...
    process {
        try {
            ...
            if ($PSBoundParameters.ContainsKey('RestoreMode')) {
                if ($PSBoundParameters['RestoreMode'] -eq [Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Support.CreateMode]::GeoRestore) {
                ...
                $Parameter.CreateMode = $PSBoundParameters['RestoreMode']
                $PSBoundParameters.Remove('RestoreMode')
            }
