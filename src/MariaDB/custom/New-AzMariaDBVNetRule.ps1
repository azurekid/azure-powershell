...
Creates or updates an existing virtual network rule.
.Example
To view examples, please use the -Online parameter with Get-Help or navigate to: https://docs.microsoft.com/en-us/powershell/module/az.mariadb/new-azmariadbvnetrule
.Inputs
...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.mariadb/new-azmariadbvnetrule
#>
function New-AzMariaDbVNetRule {
    ...
    process {
        try {
            Az.MariaDb.internal\New-AzMariaDbVNetRule @PSBoundParameters
        } catch {
            throw
        }
    }
